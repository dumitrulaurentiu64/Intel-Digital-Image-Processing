...
#define sig 2.0
#define kernel 15       // row/columns number
...
int main()
{
    ...
    /////////////////////////// get matrix from the paddedPhoto ///////////////////////////////IMG[Y * (B * W) + B*X)
    ...
    fwrite (gaussedPhoto, sizeof(gaussedPhoto), 1, g);
    fclose(f);
    fclose(g);
    printf("\nDONE!");
    return 0;
